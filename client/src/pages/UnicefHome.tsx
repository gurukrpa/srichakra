...
const UnicefHome = () => {
  ...
  return (
    <div className="min-h-screen bg-[#EDF6F9]">
      ...
      <header className="bg-[#00aeef] text-white p-4">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            <div className="font-bold text-2xl">unicef</div>
            <div className="text-xl">for every child</div>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" className="text-white border-white hover:bg-[#0099d4]">
              Press centre
            </Button>
      ...
      <section className="relative h-[500px] bg-gradient-to-r from-gray-700 to-gray-900 overflow-hidden">
        <div className="absolute inset-0 bg-black opacity-40"></div>
        <div className="container mx-auto relative z-10 flex items-end h-full pb-16">
          <div className="text-white p-6 max-w-lg">
            ...
            <Button className="bg-[#00aeef] hover:bg-[#0099d4] text-white uppercase font-bold">
              I AM
            </Button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              ...
              <Button variant="link" className="text-[#00aeef] p-0 mt-2">
                Learn more
              </Button>
            </div>
          </div>
      ...
      <footer className="bg-[#1a1a1a] text-white py-8">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
            <div>
              <h4 className="font-bold mb-4">About UNICEF</h4>
