      ...
      <html>
        <head>
          ...
          <style>
            ...
            h1 { color: #006D77; font-size: 2.5em; margin: 0 0 12px; }
            h2 { color: #006D77; border-left: 5px solid #83C5BE; padding-left: 15px; margin: 0 0 10px; page-break-after: avoid; }
            h3 { color: #E29578; margin: 0 0 8px; page-break-after: avoid; }
            p { margin: 0 0 8px; }
            ...
            .aptitude-table { page-break-inside: avoid; }
            .career-grid {
              display: grid;
        ...
        <body>
          ...
          <div class="page">
            ...
            <div class="chart-container" style="background: #f8f9fa; padding: 30px; border-radius: 15px; margin: 20px 0; border: 1px solid #e9ecef;">
            ...
            <div class="chart-container" style="background: #f8f9fa; padding: 25px; border-radius: 15px; margin: 20px 0; border: 1px solid #e9ecef;">
            ...
            <div class="chart-container" style="background: #eef7ff; padding: 22px; border-radius: 15px; border-left: 5px solid #5390D9; margin-bottom: 25px;">
          ...
          <div class="page">
            ...
            <table class="aptitude-table" style="width: 100%; border-collapse: collapse; margin: 20px 0; font-size: 0.95em;">
              <thead>
          ...
          <div class="page">
            ...
            ${topDomains.slice(0, 3).map((domain: any, idx: number) => `
              <div class="recommendation-block" style="background: linear-gradient(135deg, #f8f9fa, #e9ecef); padding: 25px; border-radius: 15px; margin-bottom: 25px; border-left: 5px solid #006D77;">
          ...
          <div class="page">
            ...
            <div class="recommendation-block" style="background: linear-gradient(135deg, #5390D9, #7209B7); color: white; padding: 25px; border-radius: 15px; margin-bottom: 30px;">
            ...
            <div class="recommendation-block" style="background: linear-gradient(135deg, #F72585, #4CC9F0); color: white; padding: 25px; border-radius: 15px; margin-bottom: 30px;">
            ...
            <div class="recommendation-block" style="background: linear-gradient(135deg, #E29578, #FFDDD2); color: #333; padding: 25px; border-radius: 15px;">
